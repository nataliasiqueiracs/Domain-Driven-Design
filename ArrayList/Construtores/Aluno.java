...
public class Aluno {
	...
	//Construtores (são sempre públicos, para permitir que um objeto seja instanciado.
	public Aluno(){
		System.out.println("Objeto Aluno Criado!");
	}
	
	// construtores parametrizados permitem instanciar já com as informações dentro
